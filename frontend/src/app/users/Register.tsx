...
export const Register = (props: Props) => {
    ...
    const [rol, setRol] = useState(ValidRoles.lector)
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const handleLogin = (form: RegisterFormsInputs) => {
        registerUser(form.email, form.username, form.password, rol, form.fullName);
    };
    return (
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    <option value={ValidRoles.creador}>Creador</option>
                                    <option value={ValidRoles.lector}>Lector</option>
                                </select>
                            </div>
